; WinIslands - Universal Inno Setup installer for the 1.0.3 stable release (x64 + ARM64)
...
[Files]
Source: "..\..\releases\1.0.3\win-x64\WinIslands.exe"; DestDir: "{app}"; Flags: ignoreversion; Check: IsX64OS
Source: "..\..\releases\1.0.3\win-arm64\WinIslands.exe"; DestDir: "{app}"; Flags: ignoreversion; Check: IsARM64
